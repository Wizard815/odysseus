...
function _renderRecipes() {
  ...
  // CUDA/ROCm backend toggle — hidden until hwfit detects both vendors (dual-GPU host).
  html += '<div id="hwfit-backend-toggle" style="display:none;flex-shrink:0;"></div>';
  ...
  html += '</select>';
  html += '<div id="hwfit-backend-toggle-launch" style="display:none;flex-shrink:0;"></div>';
